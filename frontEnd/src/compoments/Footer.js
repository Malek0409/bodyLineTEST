...
const Footer = () => {
  ...
  <footer className='pr-8 pl-8 w-full bg-white'>
    <div className='flex flex-col md:flex-row items-center py-4 space-x-48'>
        <Link to={""}>
            <img src={logoApp} className='h-20 w-32 md:h-32 md:w-48 mb-4 md:mb-0' alt="Logo" />
        </Link>
        ...
        <ul className='flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4 text-sm'>
            ...
            <li>
                <Link to={"Politique-de-confidentialite" }className='text-blue-500 hover:underline'>Politique de confidentialité</Link>
            </li>       
            <li>
            ...
            <li>
                <a href="bodyLine@gmail.com" className='text-blue-500 hover:underline'>Signaler une vulnérabilité</a>
            </li>
        </ul>
    </div>
</footer>
