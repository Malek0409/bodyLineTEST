    ...
    <div className='p-4 md:p-28'>
      <form className='m-auto w-full max-w-md shadow flex flex-col p-3 bg-white' onSubmit={handleSubmit}>
        ...
        <div className='bg-slate-200 p-4 rounded-lg shadow-md'>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex items-center">
              <input type="checkbox" id="Jambes" name="nameMuscle" value="Jambes" onChange={handleOnChange}
                className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" />
              <label htmlFor="Jambes" className="ml-2 block text-sm text-gray-900">Jambes</label>
            </div>
            <div className="flex items-center">
              <input type="checkbox" id="Fesses" name="nameMuscle" value="Fesses" onChange={handleOnChange}
                className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" />
              <label htmlFor="Fesses" className="ml-2 block text-sm text-gray-900">Fesses</label>
            </div>
            <div className="flex items-center">
              <input type="checkbox" id="Lombaire" name="nameMuscle" value="Lombaire" onChange={handleOnChange}
                className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" />
              <label htmlFor="Lombaire" className="ml-2 block text-sm text-gray-900">Lombaire</label>
            </div>
            <div className="flex items-center">
              <input type="checkbox" id="Dorceaux" name="nameMuscle" value="Dorceaux" onChange={handleOnChange}
                className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" />
              <label htmlFor="Dorceaux" className="ml-2 block text-sm text-gray-900">Dorceaux</label>
            </div>
            <div className="flex items-center">
              <input type="checkbox" id="Biceps" name="nameMuscle" value="Biceps" onChange={handleOnChange}
                className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" />
              <label htmlFor="Biceps" className="ml-2 block text-sm text-gray-900">Biceps</label>
            </div>
            <div className="flex items-center">
              <input type="checkbox" id="Triceps" name="nameMuscle" value="Triceps" onChange={handleOnChange}
                className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" />
              <label htmlFor="Triceps" className="ml-2 block text-sm text-gray-900">Triceps</label>
            </div>
            <div className="flex items-center">
              <input type="checkbox" id="Trapèzes" name="nameMuscle" value="Trapèzes" onChange={handleOnChange}
                className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" />
              <label htmlFor="Trapèzes" className="ml-2 block text-sm text-gray-900">Trapèzes</label>
            </div>
            <div className="flex items-center">
              <input type="checkbox" id="Pecteraux" name="nameMuscle" value="Pecteraux" onChange={handleOnChange}
                className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" />
              <label htmlFor="Pecteraux" className="ml-2 block text-sm text-gray-900">Pecteraux</label>
            </div>
            <div className="flex items-center">
              <input type="checkbox" id="Epaules" name="nameMuscle" value="Epaules" onChange={handleOnChange}
                className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" />
        ...
        <div className="flex flex-col sm:flex-row items-center bg-slate-200 p-4 rounded-lg shadow-md gap-4">
            ...
            <input type="text" className="bg-white p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none 
            focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" name="price" id="price" onChange={handleOnChange} value={data.price} />
            
          </div>
               <div className="flex flex-col sm:flex-row items-center w-full sm:w-auto">
    
            <label htmlFor="currency" className="block text-sm font-medium text-gray-700 mb-1 sm:mb-0 sm:mr-2">Currency</label>
            <input type="text" className="w-full bg-white p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none 
            focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" name="currency" id="currency" onChange={handleOnChange} value={data.currency} />
        ...
        <div className="flex flex-col sm:flex-row items-center w-full sm:w-auto bg-slate-200 p-4 rounded-lg shadow-md gap-4">
          ...
          <input type="text" className="bg-white p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none 
          focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" name="unitNumber" id="unitNumber" onChange={handleOnChange} value={data.unitNumber} />
            
        </div>

        <label htmlFor='description'>Description</label>
        <textarea rows={2} className='bg-slate-200 p-1 my-1 resize-none' id='description' name='description'
          onChange={handleOnChange} value={data.description}></textarea>
